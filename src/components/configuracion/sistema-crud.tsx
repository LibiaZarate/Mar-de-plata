...
const CLAVES_CONOCIDAS = [
  ...
  ["ubicacion_taxco_maps", "Link de ubicación en Google Maps · Sirena lo manda cuando alguien quiere visitar el local en Taxco"],
  ["politicas_manual_pdf", "PDF de Políticas y Manual de Compras · Sirena lo manda después de la primera FAQ respondida"],
